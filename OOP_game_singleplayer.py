...
def makeplayer():
    global player
    player = objecttemplate(height=50,width=50,x=500,y=250,vel=8,color=(0,255,0))


#making the enemy and enemy-objects
def makeenemies():
    global enemy
    enemy = objecttemplate(height=20,width=20,x=-200,y=250,vel=4,color=(255,0,255))
    global object1
    object1 = objecttemplate(height=10,width=200,x=0-200,y=230,vel=7.5,color=(255,0,0))
    global object2
    object2 = objecttemplate(height=200,width=10,x=480,y=0-200,vel=4.4,color=(255,0,0))
    global object3
    object3 = objecttemplate(height=10,width=200,x=screen_x,y=310,vel=7.5,color=(255,0,0))
    global object4
    object4 = objecttemplate(height=200,width=10,x=560,y=screen_y,vel=4.4,color=(255,0,0))
...
def enemymovement():
    ...
    #the chasing enemy
    if not enemy.rect.colliderect(object1.rect) \
    and not enemy.rect.colliderect(object2.rect) \
    and not enemy.rect.colliderect(object3.rect) \
    and not enemy.rect.colliderect(object4.rect):
...
def collision_detection():
    ...
    or player.rect.colliderect(object1.rect) \
    or player.rect.colliderect(object2.rect) \
    or player.rect.colliderect(object3.rect) \
    or player.rect.colliderect(object4.rect):
        return True
